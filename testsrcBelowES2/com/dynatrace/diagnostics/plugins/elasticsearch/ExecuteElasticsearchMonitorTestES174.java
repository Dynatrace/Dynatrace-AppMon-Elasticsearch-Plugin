...
public class ExecuteElasticsearchMonitorTestES174 extends ElasticsearchIntegrationTest {
	private static final Logger log = Logger.getLogger(ExecuteElasticsearchMonitorTestES174.class.getName());

    private static final String HTTP_PORT = "9205-9210";
	...
	public void testMain() throws Exception {
    	log.info("Preparing data in Elasticsearch node: " + client());
    	initializeIndex();
